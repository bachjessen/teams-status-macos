...
private final class ProcessExecutionState: @unchecked Sendable {
    ...
    private let outputQueue = DispatchQueue(label: "dk.bachjessen.teamsmeetingstatus.process-stdout")
    private let errorQueue = DispatchQueue(label: "dk.bachjessen.teamsmeetingstatus.process-stderr")
    private let cleanupQueue = DispatchQueue(label: "dk.bachjessen.teamsmeetingstatus.process-cleanup")
