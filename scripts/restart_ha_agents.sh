...
LOCAL_AGENT="$HOME/Library/LaunchAgents/com.homeassistant.TeamsMeetingStatus-Local.plist"
EXTERNAL_AGENT="$HOME/Library/LaunchAgents/com.homeassistant.TeamsMeetingStatus-External.plist"
