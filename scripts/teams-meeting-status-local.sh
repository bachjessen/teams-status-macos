...
ENV_FILE="${TEAMS_STATUS_ENV:-$SCRIPT_DIR/../.env}"
...
#####################################################################################
#Script Name	:teams-meeting-status-local.sh
...
teams_version="New" # Set this to EITHER "Old" or "New" depending on the teams version you are using (See GitHub documentation)
full_url="$local_url/api/states/input_text.teams_meeting_status"
previous_state_file=~/Teams_Status/previous_state.txt
powerd_log_file=~/Teams_Status/powerd_log.txt
